...
while(true){
if((i__4737__auto___27210 < len__4736__auto___27208)){
...
var len__4736__auto___27215 = arguments.length;
var i__4737__auto___27218 = (0);
while(true){
if((i__4737__auto___27218 < len__4736__auto___27215)){
args_arr__4757__auto__.push((arguments[i__4737__auto___27218]));

var G__27220 = (i__4737__auto___27218 + (1));
i__4737__auto___27218 = G__27220;
continue;
} else {
}
break;
...
/** @this {Function} */
(faber.operations_3d.csg_op.cljs$lang$applyTo = (function (seq27042){
...
while(true){
if((i__4737__auto___27223 < len__4736__auto___27221)){
args__4742__auto__.push((arguments[i__4737__auto___27223]));

var G__27225 = (i__4737__auto___27223 + (1));
i__4737__auto___27223 = G__27225;
continue;
} else {
}
break;
...
while(true){
if((i__4737__auto___27229 < len__4736__auto___27227)){
args__4742__auto__.push((arguments[i__4737__auto___27229]));

var G__27232 = (i__4737__auto___27229 + (1));
i__4737__auto___27229 = G__27232;
continue;
} else {
}
break;
...
/** @this {Function} */
(faber.operations_3d.intersection.cljs$lang$applyTo = (function (seq27050){
var self__4724__auto__ = this;
...
var map__27054 = applied_science.js_interop.lookup(v3);
...
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27054__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27054__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var z = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27054__$1,new cljs.core.Keyword(null,"z","z",-789527183));
...
var vec__27058 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27057_SHARP_){
var obj27061 = v;
var k27062 = applied_science.js_interop.impl.wrap_key(p1__27057_SHARP_);
...
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27058,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27058,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27058,(2),null);
...
var verts = (function (){var obj27067 = g;
var k27068 = "vertices";
...
var faces = (function (){var obj27074 = g;
var k27075 = "faces";
if((function (){var obj27078 = obj27074;
return (((!((obj27078 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k27075,obj27078)));
})()){
...
var vindexes = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27066_SHARP_){
var obj27080 = face;
var k27081 = applied_science.js_interop.impl.wrap_key(p1__27066_SHARP_);
...
var face_normals = cljs.core.map.cljs$core$IFn$_invoke$arity$2(faber.operations_3d.v_from_js,(function (){var obj27086 = face;
var k27087 = "vertexNormals";
if((function (){var obj27089 = obj27086;
return (((!((obj27089 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k27087,obj27089)));
})()){
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,p1__27096_SHARP_,p2__27097_SHARP_);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__27101_SHARP_){
return (p1__27101_SHARP_ * n);
}),v);
});
faber.operations_3d.vector_normalize = (function faber$operations_3d$vector_normalize(v){
var m = Math.sqrt(cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27102_SHARP_){
return (p1__27102_SHARP_ * p1__27102_SHARP_);
}),v)));
if((m === (0))){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0)], null);
} else {
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__27103_SHARP_){
return (p1__27103_SHARP_ / m);
}),v);
}
});
...
return cljs.core.vec(cljs.core.mapv.cljs$core$IFn$_invoke$arity$3((function (p1__27106_SHARP_,p2__27107_SHARP_){
return (p1__27106_SHARP_ + p2__27107_SHARP_);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(mg,new cljs.core.Keyword(null,"vertices","vertices",2008905731),(function (p1__27108_SHARP_){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$3(updatevert,p1__27108_SHARP_,cljs.core.range.cljs$core$IFn$_invoke$arity$0());
}));
});
...
var g_27247 = (function (){var obj27118 = mesh;
var k27119 = "geometry";
...
var mg_27250 = faber.operations_3d.to_mygeo((function (){var obj27121 = mesh;
var k27122 = "geometry";
if((function (){var obj27124 = obj27121;
return (((!((obj27124 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k27122,obj27124)));
})()){
return (obj27121[k27122]);
} else {
return undefined;
}
})());
var newverts_27251 = cljs.core.clj__GT_js(cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__27127){
...
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27128,(2),null);
return (new module$node_modules$three$build$three.Vector3(x,y,z));
}),new cljs.core.Keyword(null,"vertices","vertices",2008905731).cljs$core$IFn$_invoke$arity$1(faber.operations_3d.offset_mygeo(mg_27250,r)))));
(g_27247.vertices = newverts_27251);

(g_27247.verticesNeedUpdate = true);

return mesh;
});
faber.operations_3d.mesh_size_from_bounding_box = (function faber$operations_3d$mesh_size_from_bounding_box(mesh){
var g = (function (){var obj27137 = mesh;
var k27138 = "geometry";
if((function (){var obj27139 = obj27137;
return (((!((obj27139 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k27138,obj27139)));
})()){
return (obj27137[k27138]);
} else {
return undefined;
}
})();
var obj__26806__auto___27258 = g;
var f__26807__auto___27259 = (obj__26806__auto___27258["computeBoundingBox"]);
f__26807__auto___27259.call(obj__26806__auto___27258);

var map__27144 = applied_science.js_interop.lookup((function (){var obj__26806__auto__ = (function (){var obj27145 = g;
var k27146 = "boundingBox";
if((function (){var obj27147 = obj27145;
return (((!((obj27147 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k27146,obj27147)));
})()){
return (obj27145[k27146]);
} else {
return undefined;
}
})();
...
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27144__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27144__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var z = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27144__$1,new cljs.core.Keyword(null,"z","z",-789527183));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y,z], null);
});
faber.operations_3d.offset = (function faber$operations_3d$offset(p__27157,mesh){
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27158__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var meshsize = faber.operations_3d.mesh_size_from_bounding_box(mesh);
var factor = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__27156_SHARP_){
return ((p1__27156_SHARP_ + r) / p1__27156_SHARP_);
}),meshsize);
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(faber.operations_3d.scale,mesh,factor);
});
faber.operations_3d.rotate_to_XY = (function faber$operations_3d$rotate_to_XY(p__27165){
var vec__27166 = p__27165;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27166,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27166,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27166,(2),null);
...
var vertices = cljs.core.clj__GT_js(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__27174){
...
var triangles = (cljs.core.truth_(cljs.core.some((function (p1__27173_SHARP_){
return (cljs.core.count(p1__27173_SHARP_) > (3));
}),faces))?faber.operations_3d.get_trianles(points,faces):cljs.core.clj__GT_js(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__27179){
var vec__27180 = p__27179;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27180,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27180,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27180,(2),null);
return (new module$node_modules$three$build$three.Face3(a,b,c));
}),faces)));
var g = (new module$node_modules$three$build$three.Geometry());
var obj27187_27267 = g;
var obj27188_27270 = (((!((obj27187_27267 == null))))?obj27187_27267:({}));
(obj27188_27270["vertices"] = vertices);


var obj27196_27272 = g;
var obj27198_27274 = (((!((obj27196_27272 == null))))?obj27196_27272:({}));
(obj27198_27274["faces"] = triangles);


var obj__26806__auto___27277 = g;
var f__26807__auto___27278 = (obj__26806__auto___27277["computeFaceNormals"]);
f__26807__auto___27278.call(obj__26806__auto___27277);
