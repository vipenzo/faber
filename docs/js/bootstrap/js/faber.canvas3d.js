...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(faber.canvas3d.context,(function (p1__28041_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__28041_SHARP_,new cljs.core.Keyword(null,"scene","scene",1523800415),scene),new cljs.core.Keyword(null,"light","light",1918998747),light),new cljs.core.Keyword(null,"ambient-light","ambient-light",1637901620),ambient_light);
}));
});
...
var map__28057 = cljs.core.deref(faber.canvas3d.context);
...
var scene = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28057__$1,new cljs.core.Keyword(null,"scene","scene",1523800415));
var renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28057__$1,new cljs.core.Keyword(null,"renderer","renderer",336841071));
var camera = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28057__$1,new cljs.core.Keyword(null,"camera","camera",-1190348585));
...
var map__28115_28152 = cljs.core.deref(faber.canvas3d.context);
var map__28115_28153__$1 = (((((!((map__28115_28152 == null))))?(((((map__28115_28152.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28115_28152.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28115_28152):map__28115_28152);
var scene_28154 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28115_28153__$1,new cljs.core.Keyword(null,"scene","scene",1523800415));
...
scene_28154.add(mesh);
} else {
}

return faber.canvas3d.animate();
});
var the_class__27652__auto___28157 = re_view.core.class_STAR_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"lifecycle-keys","lifecycle-keys",-1618460896),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("view","did-mount","view/did-mount",914520155),(function (this$,_){
...
faber.canvas3d.canvas3dClass = the_class__27652__auto___28157;

faber.canvas3d.canvas3d = re_view.core.factory(the_class__27652__auto___28157);
