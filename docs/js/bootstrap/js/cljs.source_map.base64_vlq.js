...
var digit_50800 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_50801__$1 = (vlq >>> (5));
while(true){
if((vlq_50801__$1 > (0))){
var digit_50802__$1 = (digit_50800 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_50802__$1));

var G__50803 = (vlq_50801__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__50804 = (vlq_50801__$1 >>> (5));
digit_50800 = G__50803;
vlq_50801__$1 = G__50804;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_50800));
}
break;
}
...
var G__50813 = i__$1;
var G__50814 = result__$1;
var G__50815 = shift__$1;
i = G__50813;
result = G__50814;
shift = G__50815;
continue;
