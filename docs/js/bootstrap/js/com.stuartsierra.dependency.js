...
var com$stuartsierra$dependency$DependencyGraph$immediate_dependencies$dyn_47521 = (function (graph,node){
...
return com$stuartsierra$dependency$DependencyGraph$immediate_dependencies$dyn_47521(graph,node);
}
});

var com$stuartsierra$dependency$DependencyGraph$immediate_dependents$dyn_47522 = (function (graph,node){
var x__4428__auto__ = (((graph == null))?null:graph);
...
return com$stuartsierra$dependency$DependencyGraph$immediate_dependents$dyn_47522(graph,node);
}
});

var com$stuartsierra$dependency$DependencyGraph$transitive_dependencies$dyn_47525 = (function (graph,node){
var x__4428__auto__ = (((graph == null))?null:graph);
...
return com$stuartsierra$dependency$DependencyGraph$transitive_dependencies$dyn_47525(graph,node);
}
});

var com$stuartsierra$dependency$DependencyGraph$transitive_dependents$dyn_47526 = (function (graph,node){
var x__4428__auto__ = (((graph == null))?null:graph);
...
return com$stuartsierra$dependency$DependencyGraph$transitive_dependents$dyn_47526(graph,node);
}
});

var com$stuartsierra$dependency$DependencyGraph$nodes$dyn_47527 = (function (graph){
var x__4428__auto__ = (((graph == null))?null:graph);
...
return com$stuartsierra$dependency$DependencyGraph$nodes$dyn_47527(graph);
}
});
...
var com$stuartsierra$dependency$DependencyGraphUpdate$depend$dyn_47528 = (function (graph,node,dep){
var x__4428__auto__ = (((graph == null))?null:graph);
...
return com$stuartsierra$dependency$DependencyGraphUpdate$depend$dyn_47528(graph,node,dep);
}
});

var com$stuartsierra$dependency$DependencyGraphUpdate$remove_edge$dyn_47529 = (function (graph,node,dep){
var x__4428__auto__ = (((graph == null))?null:graph);
...
return com$stuartsierra$dependency$DependencyGraphUpdate$remove_edge$dyn_47529(graph,node,dep);
}
});

var com$stuartsierra$dependency$DependencyGraphUpdate$remove_all$dyn_47532 = (function (graph,node){
var x__4428__auto__ = (((graph == null))?null:graph);
...
return com$stuartsierra$dependency$DependencyGraphUpdate$remove_all$dyn_47532(graph,node);
}
});

var com$stuartsierra$dependency$DependencyGraphUpdate$remove_node$dyn_47534 = (function (graph,node){
var x__4428__auto__ = (((graph == null))?null:graph);
...
return com$stuartsierra$dependency$DependencyGraphUpdate$remove_node$dyn_47534(graph,node);
}
});

com.stuartsierra.dependency.remove_from_map = (function com$stuartsierra$dependency$remove_from_map(amap,x){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__47443){
var vec__47444 = p__47443;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47444,(0),null);
var vs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47444,(1),null);
...
(com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k47454,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__47464 = k47454;
var G__47464__$1 = (((G__47464 instanceof cljs.core.Keyword))?G__47464.fqn:null);
switch (G__47464__$1) {
case "dependencies":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k47454,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__47468){
var vec__47469 = p__47468;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47469,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47469,(1),null);
...
(com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this47455,other47456){
var self__ = this;
var this47455__$1 = this;
return (((!((other47456 == null)))) && ((this47455__$1.constructor === other47456.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47455__$1.dependencies,other47456.dependencies)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47455__$1.dependents,other47456.dependents)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47455__$1.__extmap,other47456.__extmap)));
}));
...
(com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__47453){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__47484 = cljs.core.keyword_identical_QMARK_;
var expr__47485 = k__4388__auto__;
if(cljs.core.truth_((pred__47484.cljs$core$IFn$_invoke$arity$2 ? pred__47484.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),expr__47485) : pred__47484.call(null,new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),expr__47485)))){
return (new com.stuartsierra.dependency.MapDependencyGraph(G__47453,self__.dependents,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__47484.cljs$core$IFn$_invoke$arity$2 ? pred__47484.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"dependents","dependents",136812837),expr__47485) : pred__47484.call(null,new cljs.core.Keyword(null,"dependents","dependents",136812837),expr__47485)))){
return (new com.stuartsierra.dependency.MapDependencyGraph(self__.dependencies,G__47453,self__.__meta,self__.__extmap,null));
} else {
return (new com.stuartsierra.dependency.MapDependencyGraph(self__.dependencies,self__.dependents,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__47453),null));
}
}
}));
...
(com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__47453){
var self__ = this;
var this__4379__auto____$1 = this;
return (new com.stuartsierra.dependency.MapDependencyGraph(self__.dependencies,self__.dependents,G__47453,self__.__extmap,self__.__hash));
}));
 ...
 */
com.stuartsierra.dependency.map__GT_MapDependencyGraph = (function com$stuartsierra$dependency$map__GT_MapDependencyGraph(G__47460){
var extmap__4419__auto__ = (function (){var G__47501 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__47460,new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"dependents","dependents",136812837)], 0));
if(cljs.core.record_QMARK_(G__47460)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__47501);
} else {
return G__47501;
}
})();
return (new com.stuartsierra.dependency.MapDependencyGraph(new cljs.core.Keyword(null,"dependencies","dependencies",1108064605).cljs$core$IFn$_invoke$arity$1(G__47460),new cljs.core.Keyword(null,"dependents","dependents",136812837).cljs$core$IFn$_invoke$arity$1(G__47460),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
return cljs.core.empty_QMARK_(com.stuartsierra.dependency.immediate_dependents(graph,p1__47504_SHARP_));
});})(sorted,g))
...
var vec__47513 = cljs.core.seq(todo);
...
var node = first__47515;
var more = seq__47514__$1;
var deps = com.stuartsierra.dependency.immediate_dependencies(g,node);
var vec__47516 = (function (){var deps__$1 = deps;
var g__$1 = g;
...
var G__47540 = cljs.core.rest(deps__$1);
var G__47541 = g_SINGLEQUOTE_;
var G__47542 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(add,d);
deps__$1 = G__47540;
g__$1 = G__47541;
add = G__47542;
continue;
} else {
var G__47543 = cljs.core.rest(deps__$1);
var G__47544 = g_SINGLEQUOTE_;
var G__47545 = add;
deps__$1 = G__47543;
g__$1 = G__47544;
add = G__47545;
...
var add = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47516,(0),null);
var g_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47516,(1),null);
var G__47546 = cljs.core.cons(node,sorted);
var G__47547 = com.stuartsierra.dependency.remove_node(g_SINGLEQUOTE_,node);
var G__47548 = clojure.set.union.cljs$core$IFn$_invoke$arity$2(cljs.core.set(more),cljs.core.set(add));
sorted = G__47546;
g = G__47547;
todo = G__47548;
continue;
