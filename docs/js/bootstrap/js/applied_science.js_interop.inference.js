...
var G__35653 = cljs.core.name(tag);
var G__35654 = tag;
var fexpr__35652 = new cljs.core.PersistentArrayMap(null, 3, ["Array",new cljs.core.Symbol(null,"array","array",-440182315,null),"String",new cljs.core.Symbol(null,"string","string",-349010059,null),"Keyword",new cljs.core.Symbol(null,"keyword","keyword",-1843046022,null)], null);
return (fexpr__35652.cljs$core$IFn$_invoke$arity$2 ? fexpr__35652.cljs$core$IFn$_invoke$arity$2(G__35653,G__35654) : fexpr__35652.call(null,G__35653,G__35654));
} else {
return null;
}
}
...
var G__35657 = applied_science.js_interop.inference.infer_tags(env,form);
if((G__35657 == null)){
return null;
} else {
return applied_science.js_interop.inference.within_QMARK_(tags,G__35657);
}
} else {
return null;
}
