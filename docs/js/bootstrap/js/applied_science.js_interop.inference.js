...
var G__27773 = cljs.core.name(tag);
var G__27774 = tag;
var fexpr__27772 = new cljs.core.PersistentArrayMap(null, 3, ["Array",new cljs.core.Symbol(null,"array","array",-440182315,null),"String",new cljs.core.Symbol(null,"string","string",-349010059,null),"Keyword",new cljs.core.Symbol(null,"keyword","keyword",-1843046022,null)], null);
return (fexpr__27772.cljs$core$IFn$_invoke$arity$2 ? fexpr__27772.cljs$core$IFn$_invoke$arity$2(G__27773,G__27774) : fexpr__27772.call(null,G__27773,G__27774));
} else {
return null;
}
}
...
var G__27803 = applied_science.js_interop.inference.infer_tags(env,form);
if((G__27803 == null)){
return null;
} else {
return applied_science.js_interop.inference.within_QMARK_(tags,G__27803);
}
} else {
return null;
}
