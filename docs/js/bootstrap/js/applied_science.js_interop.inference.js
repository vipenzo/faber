...
var G__35661 = cljs.core.name(tag);
var G__35662 = tag;
var fexpr__35660 = new cljs.core.PersistentArrayMap(null, 3, ["Array",new cljs.core.Symbol(null,"array","array",-440182315,null),"String",new cljs.core.Symbol(null,"string","string",-349010059,null),"Keyword",new cljs.core.Symbol(null,"keyword","keyword",-1843046022,null)], null);
return (fexpr__35660.cljs$core$IFn$_invoke$arity$2 ? fexpr__35660.cljs$core$IFn$_invoke$arity$2(G__35661,G__35662) : fexpr__35660.call(null,G__35661,G__35662));
} else {
return null;
}
}
...
var G__35665 = applied_science.js_interop.inference.infer_tags(env,form);
if((G__35665 == null)){
return null;
} else {
return applied_science.js_interop.inference.within_QMARK_(tags,G__35665);
}
} else {
return null;
}
