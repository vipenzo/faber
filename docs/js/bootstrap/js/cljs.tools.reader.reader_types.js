...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_49776 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_49776(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_49784 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_49784(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_49787 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_49787(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_49789 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_49789(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_49790 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_49790(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_49792 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_49792(reader);
}
});
...
var G__49809 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__49810 = s.append(c);
c = G__49809;
s = G__49810;
continue;
}
