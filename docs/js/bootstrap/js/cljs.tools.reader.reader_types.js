...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_28496 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_28496(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_28498 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_28498(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_28499 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_28499(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_28501 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_28501(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_28504 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_28504(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_28509 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_28509(reader);
}
});
...
var G__28567 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__28568 = s.append(c);
c = G__28567;
s = G__28568;
continue;
}
