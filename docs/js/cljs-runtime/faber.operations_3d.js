...
args_arr__4757__auto__.push((arguments[i__4737__auto___27233]));
...
/** @this {Function} */
(faber.operations_3d.difference.cljs$lang$applyTo = (function (seq27044){
var self__4724__auto__ = this;
...
while(true){
if((i__4737__auto___27250 < len__4736__auto___27248)){
...
var map__27048 = applied_science.js_interop.lookup(v3);
...
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27048__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27048__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var z = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27048__$1,new cljs.core.Keyword(null,"z","z",-789527183));
...
if((function (){var obj27059 = obj27054;
return (((!((obj27059 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k27055,obj27059)));
})()){
...
var verts = (function (){var obj27062 = g;
var k27063 = "vertices";
if((function (){var obj27064 = obj27062;
return (((!((obj27064 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k27063,obj27064)));
})()){
return (obj27062[k27063]);
} else {
return undefined;
}
})();
var faces = (function (){var obj27065 = g;
var k27066 = "faces";
...
var vindexes = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27061_SHARP_){
var obj27068 = face;
var k27069 = applied_science.js_interop.impl.wrap_key(p1__27061_SHARP_);
if((function (){var obj27071 = obj27068;
return (((!((obj27071 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k27069,obj27071)));
})()){
...
var face_normals = cljs.core.map.cljs$core$IFn$_invoke$arity$2(faber.operations_3d.v_from_js,(function (){var obj27072 = face;
var k27073 = "vertexNormals";
if((function (){var obj27074 = obj27072;
return (((!((obj27074 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k27073,obj27074)));
})()){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__27076_SHARP_,p2__27077_SHARP_){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,p1__27076_SHARP_,p2__27077_SHARP_);
...
return (p1__27078_SHARP_ * n);
}),v);
});
faber.operations_3d.vector_normalize = (function faber$operations_3d$vector_normalize(v){
var m = Math.sqrt(cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27080_SHARP_){
return (p1__27080_SHARP_ * p1__27080_SHARP_);
}),v)));
if((m === (0))){
...
return cljs.core.vec(cljs.core.mapv.cljs$core$IFn$_invoke$arity$3((function (p1__27082_SHARP_,p2__27083_SHARP_){
return (p1__27082_SHARP_ + p2__27083_SHARP_);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(mg,new cljs.core.Keyword(null,"vertices","vertices",2008905731),(function (p1__27084_SHARP_){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$3(updatevert,p1__27084_SHARP_,cljs.core.range.cljs$core$IFn$_invoke$arity$0());
}));
});
...
var g_27276 = (function (){var obj27097 = mesh;
var k27098 = "geometry";
...
var mg_27277 = faber.operations_3d.to_mygeo((function (){var obj27100 = mesh;
var k27101 = "geometry";
if((function (){var obj27102 = obj27100;
return (((!((obj27102 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k27101,obj27102)));
})()){
return (obj27100[k27101]);
} else {
return undefined;
}
})());
var newverts_27278 = cljs.core.clj__GT_js(cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__27107){
...
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27108,(2),null);
...
var g = (function (){var obj27114 = mesh;
var k27115 = "geometry";
if((function (){var obj27118 = obj27114;
return (((!((obj27118 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k27115,obj27118)));
})()){
return (obj27114[k27115]);
} else {
return undefined;
}
})();
...
var map__27123 = applied_science.js_interop.lookup((function (){var obj__26806__auto__ = (function (){var obj27124 = g;
var k27125 = "boundingBox";
...
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27123__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27123__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var z = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27123__$1,new cljs.core.Keyword(null,"z","z",-789527183));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y,z], null);
});
faber.operations_3d.offset = (function faber$operations_3d$offset(p__27129,mesh){
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27132__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var meshsize = faber.operations_3d.mesh_size_from_bounding_box(mesh);
var factor = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__27128_SHARP_){
return ((p1__27128_SHARP_ + r) / p1__27128_SHARP_);
}),meshsize);
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(faber.operations_3d.scale,mesh,factor);
});
faber.operations_3d.rotate_to_XY = (function faber$operations_3d$rotate_to_XY(p__27137){
...
var vertices = cljs.core.clj__GT_js(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__27150){
var vec__27152 = p__27150;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27152,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27152,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27152,(2),null);
return (new module$node_modules$three$build$three.Vector3(x,y,z));
}),points));
var triangles = (cljs.core.truth_(cljs.core.some((function (p1__27147_SHARP_){
return (cljs.core.count(p1__27147_SHARP_) > (3));
}),faces))?faber.operations_3d.get_trianles(points,faces):cljs.core.clj__GT_js(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__27158){
var vec__27159 = p__27158;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27159,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27159,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27159,(2),null);
return (new module$node_modules$three$build$three.Face3(a,b,c));
}),faces)));
var g = (new module$node_modules$three$build$three.Geometry());
var obj27166_27292 = g;
var obj27167_27293 = (((!((obj27166_27292 == null))))?obj27166_27292:({}));
(obj27167_27293["vertices"] = vertices);


var obj27173_27294 = g;
var obj27174_27296 = (((!((obj27173_27294 == null))))?obj27173_27294:({}));
(obj27174_27296["faces"] = triangles);
