...
var digit_38695 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_38696__$1 = (vlq >>> (5));
while(true){
if((vlq_38696__$1 > (0))){
var digit_38697__$1 = (digit_38695 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_38697__$1));

var G__38698 = (vlq_38696__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__38699 = (vlq_38696__$1 >>> (5));
digit_38695 = G__38698;
vlq_38696__$1 = G__38699;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_38695));
}
break;
}
...
var G__38704 = i__$1;
var G__38705 = result__$1;
var G__38706 = shift__$1;
i = G__38704;
result = G__38705;
shift = G__38706;
continue;
