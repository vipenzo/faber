...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_28018 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_28018(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_28023 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_28023(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_28026 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_28026(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_28027 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_28027(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_28030 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_28030(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_28031 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_28031(reader);
}
});
...
var G__28076 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__28077 = s.append(c);
c = G__28076;
s = G__28077;
continue;
}
