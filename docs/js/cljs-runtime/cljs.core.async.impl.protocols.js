...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28644 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28644(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28645 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28645(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28651 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28651(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28652 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28652(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28653 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28653(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28654 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28654(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_28655 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_28655(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28656 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28656(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28658 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28658(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28661 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28661(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28662 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28662(b);
}
});
