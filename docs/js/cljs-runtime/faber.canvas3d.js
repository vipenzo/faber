...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(faber.canvas3d.context,(function (p1__34216_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__34216_SHARP_,new cljs.core.Keyword(null,"scene","scene",1523800415),scene),new cljs.core.Keyword(null,"light","light",1918998747),light),new cljs.core.Keyword(null,"ambient-light","ambient-light",1637901620),ambient_light);
}));
});
...
var map__34224 = cljs.core.deref(faber.canvas3d.context);
...
var scene = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34224__$1,new cljs.core.Keyword(null,"scene","scene",1523800415));
var renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34224__$1,new cljs.core.Keyword(null,"renderer","renderer",336841071));
var camera = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34224__$1,new cljs.core.Keyword(null,"camera","camera",-1190348585));
...
var map__34233_34268 = cljs.core.deref(faber.canvas3d.context);
var map__34233_34269__$1 = (((((!((map__34233_34268 == null))))?(((((map__34233_34268.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34233_34268.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34233_34268):map__34233_34268);
var scene_34270 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34233_34269__$1,new cljs.core.Keyword(null,"scene","scene",1523800415));
...
scene_34270.add(mesh);
} else {
}

return faber.canvas3d.animate();
});
var the_class__26988__auto___34279 = re_view.core.class_STAR_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"lifecycle-keys","lifecycle-keys",-1618460896),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("view","did-mount","view/did-mount",914520155),(function (this$,_){
...
faber.canvas3d.canvas3dClass = the_class__26988__auto___34279;

faber.canvas3d.canvas3d = re_view.core.factory(the_class__26988__auto___34279);
