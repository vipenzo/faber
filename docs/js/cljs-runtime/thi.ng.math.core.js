...
var G__45320 = (x - y);
return (thi.ng.math.core.abs.cljs$core$IFn$_invoke$arity$1 ? thi.ng.math.core.abs.cljs$core$IFn$_invoke$arity$1(G__45320) : thi.ng.math.core.abs.call(null,G__45320));
});
...
var thi$ng$math$core$PDeltaEquals$delta_EQ_$dyn_45521 = (function() {
var G__45522 = null;
var G__45522__2 = (function (a,b){
var x__4428__auto__ = (((a == null))?null:a);
var m__4429__auto__ = (thi.ng.math.core.delta_EQ_[goog.typeOf(x__4428__auto__)]);
...
var m__4426__auto__ = (thi.ng.math.core.delta_EQ_["_"]);
...
var G__45522__3 = (function (a,b,eps){
var x__4428__auto__ = (((a == null))?null:a);
var m__4429__auto__ = (thi.ng.math.core.delta_EQ_[goog.typeOf(x__4428__auto__)]);
if((!((m__4429__auto__ == null)))){
return (m__4429__auto__.cljs$core$IFn$_invoke$arity$3 ? m__4429__auto__.cljs$core$IFn$_invoke$arity$3(a,b,eps) : m__4429__auto__.call(null,a,b,eps));
} else {
var m__4426__auto__ = (thi.ng.math.core.delta_EQ_["_"]);
if((!((m__4426__auto__ == null)))){
return (m__4426__auto__.cljs$core$IFn$_invoke$arity$3 ? m__4426__auto__.cljs$core$IFn$_invoke$arity$3(a,b,eps) : m__4426__auto__.call(null,a,b,eps));
} else {
throw cljs.core.missing_protocol("PDeltaEquals.delta=",a);
}
}
});
G__45522 = function(a,b,eps){
switch(arguments.length){
case 2:
return G__45522__2.call(this,a,b);
case 3:
return G__45522__3.call(this,a,b,eps);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__45522.cljs$core$IFn$_invoke$arity$2 = G__45522__2;
G__45522.cljs$core$IFn$_invoke$arity$3 = G__45522__3;
return G__45522;
})()
;
...
return thi$ng$math$core$PDeltaEquals$delta_EQ_$dyn_45521(a,b);
}
}));
...
return thi$ng$math$core$PDeltaEquals$delta_EQ_$dyn_45521(a,b,eps);
}
}));
...
var G__45526 = null;
var G__45526__2 = (function (a,b){
if(typeof b === 'number'){
return ((function (){var G__45333 = (a - b);
return (thi.ng.math.core.abs.cljs$core$IFn$_invoke$arity$1 ? thi.ng.math.core.abs.cljs$core$IFn$_invoke$arity$1(G__45333) : thi.ng.math.core.abs.call(null,G__45333));
})() <= thi.ng.math.core._STAR_eps_STAR_);
} else {
return null;
}
});
var G__45526__3 = (function (a,b,eps){
if(typeof b === 'number'){
return ((function (){var G__45334 = (a - b);
return (thi.ng.math.core.abs.cljs$core$IFn$_invoke$arity$1 ? thi.ng.math.core.abs.cljs$core$IFn$_invoke$arity$1(G__45334) : thi.ng.math.core.abs.call(null,G__45334));
})() <= eps);
} else {
return null;
}
});
G__45526 = function(a,b,eps){
switch(arguments.length){
case 2:
return G__45526__2.call(this,a,b);
case 3:
return G__45526__3.call(this,a,b,eps);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
if(cljs.core.truth_(thi.ng.math.core.delta_EQ_(cljs.core.first(a__$2),cljs.core.first(b__$1)))){
var G__45529 = cljs.core.next(a__$2);
var G__45530 = cljs.core.next(b__$1);
a__$2 = G__45529;
b__$1 = G__45530;
continue;
} else {
...
var G__45532 = cljs.core.next(a__$2);
var G__45533 = cljs.core.next(b__$1);
a__$2 = G__45532;
b__$1 = G__45533;
continue;
} else {
...
if(cljs.core.truth_(a__$2)){
if(cljs.core.truth_(thi.ng.math.core.delta_EQ_(cljs.core.first(a__$2),cljs.core.first(b__$1)))){
var G__45534 = cljs.core.next(a__$2);
var G__45535 = cljs.core.next(b__$1);
a__$2 = G__45534;
b__$1 = G__45535;
continue;
} else {
...
if(cljs.core.truth_(a__$2)){
if(cljs.core.truth_(thi.ng.math.core.delta_EQ_(cljs.core.first(a__$2),cljs.core.first(b__$1),eps))){
var G__45536 = cljs.core.next(a__$2);
var G__45537 = cljs.core.next(b__$1);
a__$2 = G__45536;
b__$1 = G__45537;
continue;
} else {
...
if(cljs.core.truth_(a__$2)){
if(cljs.core.truth_(thi.ng.math.core.delta_EQ_(cljs.core.first(a__$2),cljs.core.first(b__$1)))){
var G__45539 = cljs.core.next(a__$2);
var G__45540 = cljs.core.next(b__$1);
a__$2 = G__45539;
b__$1 = G__45540;
continue;
} else {
...
if(cljs.core.truth_(a__$2)){
if(cljs.core.truth_(thi.ng.math.core.delta_EQ_(cljs.core.first(a__$2),cljs.core.first(b__$1),eps))){
var G__45542 = cljs.core.next(a__$2);
var G__45543 = cljs.core.next(b__$1);
a__$2 = G__45542;
b__$1 = G__45543;
continue;
} else {
...
if(cljs.core.truth_(a__$2)){
if(cljs.core.truth_(thi.ng.math.core.delta_EQ_(cljs.core.first(a__$2),cljs.core.first(b__$1)))){
var G__45546 = cljs.core.next(a__$2);
var G__45547 = cljs.core.next(b__$1);
a__$2 = G__45546;
b__$1 = G__45547;
continue;
} else {
...
if(cljs.core.truth_(a__$2)){
if(cljs.core.truth_(thi.ng.math.core.delta_EQ_(cljs.core.first(a__$2),cljs.core.first(b__$1),eps))){
var G__45548 = cljs.core.next(a__$2);
var G__45549 = cljs.core.next(b__$1);
a__$2 = G__45548;
b__$1 = G__45549;
continue;
} else {
...
var G__45550 = null;
var G__45550__2 = (function (_,b){
return (b == null);
});
var G__45550__3 = (function (_,b,___$1){
return (b == null);
});
G__45550 = function(_,b,___$1){
switch(arguments.length){
case 2:
return G__45550__2.call(this,_,b);
case 3:
return G__45550__3.call(this,_,b,___$1);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__45550.cljs$core$IFn$_invoke$arity$2 = G__45550__2;
G__45550.cljs$core$IFn$_invoke$arity$3 = G__45550__3;
return G__45550;
})()
);
/**
...
(thi.ng.math.core.map_interval.cljs$core$IFn$_invoke$arity$3 = (function (x,p__45384,p__45385){
var vec__45386 = p__45384;
var in1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45386,(0),null);
var in2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45386,(1),null);
var vec__45389 = p__45385;
var out1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45389,(0),null);
var out2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45389,(1),null);
...
(thi.ng.math.core.map_interval_clamped.cljs$core$IFn$_invoke$arity$3 = (function (x,p__45399,p__45400){
var vec__45401 = p__45399;
var in1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45401,(0),null);
var in2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45401,(1),null);
var vec__45404 = p__45400;
var out1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45404,(0),null);
var out2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45404,(1),null);
...
(thi.ng.math.core.map_interval_clamped.cljs$core$IFn$_invoke$arity$4 = (function (x,p__45415,p__45416,p__45417){
var vec__45418 = p__45415;
var in1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45418,(0),null);
var in2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45418,(1),null);
var vec__45421 = p__45416;
var out1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45421,(0),null);
var out2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45421,(1),null);
var vec__45424 = p__45417;
var c1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45424,(0),null);
var c2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45424,(1),null);
...
(thi.ng.math.core.in_range_QMARK_.cljs$core$IFn$_invoke$arity$2 = (function (p__45434,x){
var vec__45435 = p__45434;
var min = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45435,(0),null);
var max = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45435,(1),null);
if((x >= min)){
return (x <= max);
} else {
return null;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45442_SHARP_){
return (p1__45442_SHARP_ / n);
...
var v = (((b - a) * t) + a);
return ((((t < pos))?(((function (){var G__45463 = a;
var G__45464 = (((b - a) * pos) + a);
var G__45465 = (t / pos);
var fexpr__45462 = (((strength > (0)))?thi.ng.math.core.mix_circular_flipped:thi.ng.math.core.mix_circular);
return (fexpr__45462.cljs$core$IFn$_invoke$arity$3 ? fexpr__45462.cljs$core$IFn$_invoke$arity$3(G__45463,G__45464,G__45465) : fexpr__45462.call(null,G__45463,G__45464,G__45465));
})() - v) * (thi.ng.math.core.abs.cljs$core$IFn$_invoke$arity$1 ? thi.ng.math.core.abs.cljs$core$IFn$_invoke$arity$1(strength) : thi.ng.math.core.abs.call(null,strength))):(((function (){var G__45467 = (((b - a) * pos) + a);
var G__45468 = b;
var G__45469 = ((t - pos) / (1.0 - pos));
var fexpr__45466 = (((strength < (0)))?thi.ng.math.core.mix_circular_flipped:thi.ng.math.core.mix_circular);
return (fexpr__45466.cljs$core$IFn$_invoke$arity$3 ? fexpr__45466.cljs$core$IFn$_invoke$arity$3(G__45467,G__45468,G__45469) : fexpr__45466.call(null,G__45467,G__45468,G__45469));
...
var vec__45509 = thi.ng.math.core.quartile_range(n,cljs.core.count(sorted));
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45509,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45509,(1),null);
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45514_SHARP_){
return (s * p1__45514_SHARP_);
}),ws);
}));
