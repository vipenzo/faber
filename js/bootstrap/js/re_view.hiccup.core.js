...
var re_view$hiccup$core$IElement$to_element$dyn_26415 = (function (this$){
...
return re_view$hiccup$core$IElement$to_element$dyn_26415(this$);
}
});
...
try{var vec__26366 = re_view.hiccup.hiccup.parse_key_memoized((form.cljs$core$IFn$_invoke$arity$1 ? form.cljs$core$IFn$_invoke$arity$1((0)) : form.call(null,(0))));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26366,(0),null);
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26366,(1),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26366,(2),null);
var classes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26366,(3),null);
var vec__26369 = re_view.hiccup.hiccup.parse_args(form);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26369,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26369,(1),null);
...
}catch (e26364){if((e26364 instanceof Error)){
var e = e26364;
...
var G__26400 = re_view.hiccup.core.to_hiccup(form);
return (re_view.hiccup.core._to_element.cljs$core$IFn$_invoke$arity$1 ? re_view.hiccup.core._to_element.cljs$core$IFn$_invoke$arity$1(G__26400) : re_view.hiccup.core._to_element.call(null,G__26400));
} else {
if(cljs.core.list_QMARK_(form)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (out,el){
var G__26401 = out;
G__26401.push((re_view.hiccup.core._to_element.cljs$core$IFn$_invoke$arity$1 ? re_view.hiccup.core._to_element.cljs$core$IFn$_invoke$arity$1(el) : re_view.hiccup.core._to_element.call(null,el)));
...
(re_view.hiccup.core.element.cljs$core$IFn$_invoke$arity$2 = (function (form,p__26408){
...
var wrap_props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26409__$1,new cljs.core.Keyword(null,"wrap-props","wrap-props",-983244308));
var create_element = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26409__$1,new cljs.core.Keyword(null,"create-element","create-element",193243064));
var _STAR_wrap_props_STAR__orig_val__26411 = re_view.hiccup.hiccup._STAR_wrap_props_STAR_;
var _STAR_create_element_STAR__orig_val__26412 = re_view.hiccup.hiccup._STAR_create_element_STAR_;
var _STAR_wrap_props_STAR__temp_val__26413 = wrap_props;
var _STAR_create_element_STAR__temp_val__26414 = (function (){var or__4126__auto__ = re_view.hiccup.hiccup._STAR_create_element_STAR_;
...
(re_view.hiccup.hiccup._STAR_wrap_props_STAR_ = _STAR_wrap_props_STAR__temp_val__26413);

(re_view.hiccup.hiccup._STAR_create_element_STAR_ = _STAR_create_element_STAR__temp_val__26414);

try{return re_view.hiccup.core._to_element(form);
}finally {(re_view.hiccup.hiccup._STAR_create_element_STAR_ = _STAR_create_element_STAR__orig_val__26412);

(re_view.hiccup.hiccup._STAR_wrap_props_STAR_ = _STAR_wrap_props_STAR__orig_val__26411);
}}));
